...
sources:
  - name: "Hacker News"
    ...
    tier: 5
    type: "community"
    metrics: { points: 354, comments: 163 }
takeaways:
  - "Open‑source macOS app shows fruit fly brain in 3D."
  - "Uses real FlyWire connectome data for neural visualization."
  - "Enables desktop‑based exploration of connectome structures."
---
