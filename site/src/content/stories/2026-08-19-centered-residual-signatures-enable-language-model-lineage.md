...
sources:
  - name: "arXiv cs.LG"
    ...
    type: "lab"
takeaways:
  - "Centered residual signatures detect model provenance from weights alone."
  - "Works despite fine‑tuning, quantization, pruning, or merging."
  - "Enables data‑free white‑box lineage verification for open‑weight LLMs."
---
